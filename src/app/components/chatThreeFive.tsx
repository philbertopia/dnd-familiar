...
export function ChatThreeFive() {
    ...
    return (
        <main className="flex mt-3 flex-col w-full h-screen max-h-dvh bg-background">

            <header className="p-3 border-b w-full max-w-3xl mx-auto">
                <h1 className="text-2xl font-bold">3.5 Rules Lord</h1>
            </header>
            ...
            <section className="container px-0 pb-10 flex flex-col flex-grow gap-3 mx-auto max-w-3xl">
